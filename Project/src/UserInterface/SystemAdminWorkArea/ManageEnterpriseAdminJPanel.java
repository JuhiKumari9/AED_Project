...
//        }
            ...
            if (system.checkUserIdExists(username)) {
                ...
                if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.HospitalEnterprise) {
                    account = enterprise.getUserAccountDirectory().createAndAddAccount(username, password, employee, new HospitalEnterpriseAdmin());
                ...
                } else if (enterprise.getEnterpriseType() == Enterprise.EnterpriseType.MentalHealthEnterprise) {
                    account = enterprise.getUserAccountDirectory().createAndAddAccount(username, password, employee, new MentalHealthEnterpriseAdmin());
