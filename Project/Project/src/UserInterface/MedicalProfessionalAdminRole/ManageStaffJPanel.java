...
//    }
    ...
    private void initComponents() {
        ...
        expertiseComboBox.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Teach new skills", "Assign homework and tasks", "challenge illogical beliefs", "Explore pas experiences", "Teach mindfullness", "Active listener", "Explore personal meaning to experiences", "Instill hope", "Collaborate" }));
