...
public class GOVTAdminManageEmployeesJPanel extends javax.swing.JPanel {
    ...
    public GOVTAdminManageEmployeesJPanel(JPanel userProcessContainer, Enterprise enterprise, OrganizationDirectory orgDirectory) {
        initComponents();
...
//        populateNurseTable();
    ...
    private void populateDoctorTable(){
        ...
        for (Representative onl : org.getRepresentativeDirectory().getRepresentativeList()){
         ...
         for (Executive onl : org.getExecutiveDirectory().getExecutiveList()){
            Object[] row = new Object[5];
            row[0] = onl;         
            row[1] = onl.getContactNumber();
            row[2] = onl.getZipcode();
...
//        expertise = expertiseComboBox.getSelectedItem().toString();
        ...
        if(orga.getType().getValue().equalsIgnoreCase("GOVT Representative Organization")){
            Representative representative = new Representative(name, contact, zipcode, city, gender, username, password, dateOfBirth, state, city, email, new Business.Role.Representative(),orga);
            orga.getRepresentativeDirectory().addRepresentative(representative);
            orga.getUserAccountDirectory().addUserAccount(representative);
        }else if(orga.getType().getValue().equalsIgnoreCase("Executive Organization")){
            Executive executive = new Executive(name, contact, zipcode, city, gender, username, password, dateOfBirth, state, city, email, new Business.Role.Executive(),orga);
            orga.getExecutiveDirectory().addExecutive(executive);
            orga.getUserAccountDirectory().addUserAccount(executive);
        }
        populateDoctorTable();
