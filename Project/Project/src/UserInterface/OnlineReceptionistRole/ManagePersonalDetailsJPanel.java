 ...
 * @author amishagupta
 */
public class ManagePersonalDetailsJPanel extends javax.swing.JPanel {
    ...
    private OnlineReceptionist organisationUser;
    DateFormat formatter = new SimpleDateFormat("MM/dd/yyyy");

    
    public ManagePersonalDetailsJPanel(JPanel userProcessContainer,Ecosystem system,Organization org,Enterprise ent, UserAccount useracount) {
        initComponents();
        ...
        populateUsCities();
        populateUsStates();
        organisationUser = org.getOnlineReceptionistDirectory().findUserByUserName(useracount.getUsername());
        populateData();
    }
...
//    }
    ...
    public void populateData(){
        ...
        try {
            ...
            Logger.getLogger(ManagePersonalDetailsJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
