 ...
 * @author amishagupta
 */
public class ManagePersonalDetailsGTJPanel extends javax.swing.JPanel {
    ...
    private GeneralTherapist organisationUser;
    DateFormat formatter = new SimpleDateFormat("MM/dd/yyyy");

    
    public ManagePersonalDetailsGTJPanel(JPanel userProcessContainer,Ecosystem system,Organization org,Enterprise ent, UserAccount useracount) {
        initComponents();
        ...
        populateUsCities();
        populateUsStates();
        organisationUser = org.getGeneralTherapistDirectory().findUserByUserName(useracount.getUsername());
        populateData();
    }
...
//    }
    ...
    private void initComponents() {
        ...
        add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 80, 760, 350));

        jLabel13.setText("Personal Details");
        add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 20, 140, -1));
    ...
    public void populateData(){
        ...
        try {
            ...
            Logger.getLogger(ManagePersonalDetailsGTJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
