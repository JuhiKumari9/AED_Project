 ...
 * @author juhip
 */
public class ManageAllExpertRequestsJPanel extends javax.swing.JPanel {
    ...
    public ManageAllExpertRequestsJPanel(JPanel userProcessContainer, Ecosystem system, UserAccount userAccount, Organization org, Enterprise ent) {
        initComponents();
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        RequestDetailsExpertJPanel receptionistRequestDetails=new RequestDetailsExpertJPanel(userProcessContainer,system, userAccount,request, org, ent);
    ...
    // End of variables declaration//GEN-END:variables
        ...
        DefaultTableModel model = (DefaultTableModel) requestDetailsTable.getModel();
            ExpertTherapist therapist = org.getExpertTherapistDirectory().findUserByUserName(userAccount.getUsername());
        model.setRowCount(0);
