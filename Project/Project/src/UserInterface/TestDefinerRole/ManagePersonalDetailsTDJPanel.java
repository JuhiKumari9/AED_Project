 ...
 * @author amishagupta
 */
public class ManagePersonalDetailsTDJPanel extends javax.swing.JPanel {
    ...
    private TestDefiner organisationUser;
    DateFormat formatter = new SimpleDateFormat("MM/dd/yyyy");

    
    public ManagePersonalDetailsTDJPanel(JPanel userProcessContainer,Ecosystem system,Organization org,Enterprise ent, UserAccount useracount) {
        initComponents();
        ...
        populateUsCities();
        populateUsStates();
        organisationUser = org.getTestDefinerDirectory().findUserByUserName(useracount.getUsername());
        populateData();
    }
...
//    }
    ...
    public void populateData(){
        ...
        try {
            ...
            Logger.getLogger(ManagePersonalDetailsTDJPanel.class.getName()).log(Level.SEVERE, null, ex);
        }
